...
<div class="container mx-auto px-6 py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-800">Slider Banners</h1>
        <a href="{{ route('admin.banners.create') }}" class="bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg font-semibold transition flex items-center">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <img src="{{ asset('images/banners/' . $banner->image) }}" alt="{{ $banner->title }}" class="w-24 h-16 object-cover rounded-lg shadow">
                        </td>
                        <td class="px-6 py-4">
                            <div class="text-sm font-medium text-gray-900">{{ $banner->title }}</div>
                        </td>
                        <td class="px-6 py-4">
                            <div class="text-sm text-gray-500">{{ Str::limit($banner->subtitle, 30) }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            @if($banner->is_active)
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex space-x-2">
                                <a href="{{ route('admin.banners.edit', $banner) }}" class="text-blue-600 hover:text-blue-900">
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-12 text-center text-gray-500">
                            ...
                            <p class="mt-4">No banners found. Add your first banner!</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
