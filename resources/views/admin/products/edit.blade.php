...
<div class="container mx-auto px-6 py-8">
    <div class="mb-6">
        <a href="{{ route('admin.products.index') }}" class="text-purple-600 hover:text-purple-800 flex items-center">
        ...
        <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="flex items-center">
                    ...
                    <label for="is_active" class="ml-2 text-sm font-medium text-gray-700">Active Product</label>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    @if($product->image)
                    <img src="{{ asset('images/products/' . $product->image) }}" alt="{{ $product->name }}" class="w-32 h-32 object-cover rounded-lg shadow-md">
                    @else
                ...
                <!-- New Image Upload -->
                <div class="md:col-span-2">
                    <label for="image" class="block text-sm font-medium text-gray-700 mb-2">Change Product Image (Optional)</label>
                    ...
                    <div id="imagePreview" class="mt-4 hidden">
                        <img id="preview" class="max-w-xs rounded-lg shadow-md" alt="New image preview">
                    </div>
                    @error('image')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
